...
var themeBtnHolder = '<div class="bctheme-holder">'+themeBtn1+themeBtn3+'</div>';
var themeBtnStyle = '<style>.bctheme-holder{display:inline-block;position:fixed;width:1.5rem;top:50%;right:1rem;z-index:999999} .bctheme{display:inline-block;width:1.5rem;height:1.5rem;border:0.2rem solid #fff;border-radius:2rem;cursor:pointer;box-shadow: 0 0.2rem 0.5rem rgba(0,0,0,0.2);} .bctheme.t1{background-color:#0971da} .bctheme.t3{background-color:#5A6771}</style>';
